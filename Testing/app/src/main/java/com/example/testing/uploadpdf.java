...
public class uploadpdf extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText filename,uploadername;
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        sRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                Uri downloadurl=uri;
                                final Upload upload = new Upload(filename.getText().toString(),uploadername.getText().toString() ,downloadurl.toString());
        ...
        switch (v.getId()) {
            case R.id.upload:
                if(TextUtils.isEmpty(filename.getText().toString())){
                    filename.setError("This Field is Mandatory");
                    return;
                }
                getPDF();
                break;
